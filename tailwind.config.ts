  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        "notebook-lines":
          'url(\'data:image/svg+xml,%3Csvg width="100" height="100" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" stroke="%23000000" stroke-width="1" opacity="0.4"%3E%3Cline x1="0" y1="20" x2="100" y2="20"/%3E%3Cline x1="0" y1="40" x2="100" y2="40"/%3E%3Cline x1="0" y1="60" x2="100" y2="60"/%3E%3Cline x1="0" y1="80" x2="100" y2="80"/%3E%3Cline x1="10" y1="0" x2="10" y2="100"/%3E%3C/g%3E%3C/svg%3E\')',
        pattern:
